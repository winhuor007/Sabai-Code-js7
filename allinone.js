...
class Book {
  ...
  return() {
    ...
    else console.log("this book is already returned");
  }
  toString() {
...
class User {
  ...
  borrowBook(book) {
    ...
    } else console.log("There is no such book");
  }
  viewBook() {
    let forOuput = "[\n";
...
class Student extends User {
  ...
  borrowBook(book) {
    ...
    } else console.log("You can borrow only 5 books");
  }
}
...
//instance
let library = new Library("Library A", [
  new Book("hary", "a", "magic", true),
...
let student = new Student("user1", [
  new Book("hary2", "3", "magic", true),
